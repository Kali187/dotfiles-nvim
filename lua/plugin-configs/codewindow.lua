require('codewindow').setup({
	active_in_terminals = false,                                                   -- Should the minimap activate for terminal buffefers
	...
	window_border = 'double',                                                      -- The border style of the floating window (accepts all usual options)
